...
export default function HeroSection({ remoteSoftwareUrl, marqueeItems }: HeroSectionProps) {
  return (
    <section className="relative w-full text-white overflow-hidden border-b border-[#1c692b] bg-[#237F34] flex flex-col justify-between pt-8 sm:pt-10 lg:pt-12 pb-0 min-h-[760px] sm:min-h-[820px]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center justify-start space-y-3 sm:space-y-4 pt-2 sm:pt-4 pb-8 sm:pb-12">
        ...
        {/* Central Outer Container Box - BLACK Background with GREEN Border */}
        <div className="w-full rounded-[20px] sm:rounded-[26px] bg-[#040e06]/95 border-2 border-[#65C400] shadow-[0_0_50px_rgba(0,0,0,0.7)] backdrop-blur-md space-y-4 sm:space-y-5 my-1 max-w-4xl p-4 sm:p-5">
          ...
          {/* Direct Display: 3 Platform Download Cards - GREEN Download Boxes */}
